...
public class UserService {
    ...
    // mày muốn lấy cái userId => Account account = authenticationService.getCurrentAccountByUserName();
    // lấy userId của cái account đang thao tác =>  String currentUserId = account.getUserId();
