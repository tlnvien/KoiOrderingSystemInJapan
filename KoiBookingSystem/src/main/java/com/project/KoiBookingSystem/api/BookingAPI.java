...
//    public ResponseEntity bookingPaymentCallback(@RequestParam Map<String, String> vnpParams) {
//        String result = vnPayService.handleBookingPaymentCallBack(vnpParams);
