...
public class KoiService {
    ...
    public List<KoiResponse> searchKoi(String species, String farmName) {
        ...
        if (species != null && !species.isEmpty() && farmName != null && !farmName.isEmpty()) {
            koiList =  koiRepository.findBySpeciesAndKoiFarmsFarmFarmNameAndStatusTrue(species, farmName);
        } else if (species != null && !species.isEmpty()) {
            koiList =  koiRepository.findKoisBySpeciesAndStatusTrue(species);
        } else if (farmName != null && !farmName.isEmpty()) {
            koiList = koiRepository.findByKoiFarmsFarmFarmNameAndStatusTrue(farmName);
        } else {
