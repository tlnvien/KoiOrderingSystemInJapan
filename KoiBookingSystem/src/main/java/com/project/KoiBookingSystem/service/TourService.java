...
public class TourService {
    ...
    public void startTour(String tourId) {
        ...
        tourRepository.save(startedTour);
    }

    public void endTour(String tourId) {
        ...
        tourRepository.save(endedTour);
    }

//    private void requestCancelFromConsulting(String tourId) {
//        Account consulting = authenticationService.getCurrentAccount();
//        if (consulting == null || !consulting.getRole().equals(Role.CONSULTING)) {
//            throw new ActionException("Invalid activity! Only consulting staff can perfom this action!");
//        }
//        Tour tour = getTourByTourId(tourId);
//        if (!tour.getConsulting().equals(consulting)) {
//            throw new ActionException("You can not request to cancel this tour!");
//        }
//        tour.setConsulting(null);
...
//    }
    ...
    public void checkConsultingStatus(Account consulting, LocalDate newTourDepartureDate) {
        List<Tour> activeTours = tourRepository.findActiveToursByConsultingAndEndDateAfter(consulting, newTourDepartureDate);
