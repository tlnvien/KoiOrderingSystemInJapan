...
public class OrderAPI {
    ...
    public ResponseEntity getAllOrdersByFarmHost() {
        List<OrderResponse> orderResponses = orderService.getAllOrdersByFarmHost();
        return ResponseEntity.ok(orderResponses);
    }

    @GetMapping("/farm/{farmId}")
    @PreAuthorize("hasAnyAuthority('CONSULTING', 'DELIVERING', 'MANAGER')")
    public ResponseEntity getAllOrdersByFarm(@PathVariable String farmId) {
    ...
    @PreAuthorize("hasAnyAuthority('CONSULTING', 'CUSTOMER', 'FARM_HOST')")
    public ResponseEntity getOrderDetailByOrder(@PathVariable String orderId) {
        List<OrderDetailResponse> orderDetailResponses = orderService.getAllOrderDetailByOrder(orderId);
